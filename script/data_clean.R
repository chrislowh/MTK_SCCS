...
load(file="data/raw/Asthma_all ddx.RData")
...
for (i in df_names) {
  ...
  write.csv(df,file= paste0('data/raw/', i, '.csv'))
  
}


# Check if the file exists
file_path <- "data/raw/Asthma_RX.RDS"
